...
function useRoles() {
    var _a = use_neo4j_1.useReadCypher('SHOW POPULATED ROLES WITH USERS'), loading = _a.loading, error = _a.error, records = _a.records;
...
function useUsers() {
    var _a = use_neo4j_1.useReadCypher('SHOW USERS', {}, 'system'), loading = _a.loading, error = _a.error, records = _a.records;
